(function () {
  ...
  function checkLinks() {
    ...
    if (missing.length) {
      console.warn('Missing affiliate links on this page:', missing);
    } else {
      console.log('All affiliate links found on this page.');
    }
  }
  ...
  function makePopup() {
    ...
    box.style.cssText = 'max-width:420px;width:100%;background:#fff;border-radius:18px;padding:24px;box-shadow:0 18px 60px rgba(0,0,0,.25);font-family:Arial,sans-serif;color:#111;';
    ...
    box.innerHTML = `
      ...
      <div style="display:flex;gap:10px;flex-wrap:wrap;">
        <a id="exit-pop-cta" href="https://www.booking.com/index.html?aid=1858279" target="_blank" rel="nofollow sponsored noopener" style="background:#0b63f6;color:#fff;text-decoration:none;padding:12px 16px;border-radius:10px;font-weight:700;">Check prices</a>
